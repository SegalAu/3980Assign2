	...
	LPSTR lspszCmdParam, int nCmdShow)
{
	...
	//Initially disable connect button to prevent users from trying to connect before selecting comm port and configurations
	...
	WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDM_EXIT_APP:
			...
			break;
		case IDM_CONNECT:
			connectSerialPort(&hComm, lpszCommName);
			connected = true;

			//Disable menu connect button to intuitively show users they are connected
			EnableMenuItem(GetMenu(hwnd), IDM_CONNECT, MF_DISABLED);
